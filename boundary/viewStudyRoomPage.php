...
require_once "../controller/ViewStudyRoomController.php";

$controller = new ViewStudyRoomController();
$studyRooms = $controller->getAvailableStudyRooms($_SESSION['university_id']);
?>
...
<head>
    ...
    <title>Available Study Rooms - UniBee</title>
...
<body>
    ...
    <main class="dashboard">
        ...
        <!-- Study Rooms List -->
        <?php if ($studyRooms === false): ?>
            <p class="error-message">Unable to load study room information, please try again.</p>

        <?php elseif (empty($studyRooms)): ?>
            <p class="no-notifications">No study rooms are currently available.</p>

        <?php else: ?>

            <div class="facility-list">

                <?php foreach ($studyRooms as $room): ?>
